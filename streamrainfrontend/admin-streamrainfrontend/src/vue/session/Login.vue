		...
		<div class="vertical-align-wrap" >
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
						<div class="logo text-center"><img src="../../assets/img/streamrainLogo.png" alt="..."></div>
						<p class="lead">Administracion de StreamRain</p>
						</div>
    ...
    login: function () {
      ...
      if (nickname.trim() !== '' && password.trim() !== '') {
        if (this.buttonEnable) {
          ...
          this.$http.post(`${this.config.backend}/administrator/login`,
            {
              username: nickname,
              password,
              twitter: false,
            ...
            },
            {
              ...
              localStorage.setItem(`streamrain-session`, JSON.stringify(newSession));
