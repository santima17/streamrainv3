          ...
          <ul class="nav navbar-nav">	
            <li class="dropdown">
              ...
              <ul class="dropdown-menu user-menu menu-icon">
                <li class="menu-heading">Configuracion</li>
                <li><a href="#"><i class="fa fa-fw fa-edit"></i> <span>Datos de la cuenta</span></a></li>
                <li><a href="#"><i class="fa fa-key" aria-hidden="true"></i> <span>Cambiar contrasena</span></a></li>
      ...
      <ul id="main-menu" class="metismenu">
        <li class="">
          ...
          <ul aria-expanded="true">
            ...
            <li class=""><router-link to="/content/FeaturedVOD">Destacar</router-link></li>
            <li class=""><router-link to="/content/PPV">Pay-Per-View</router-link></li>
            <li class=""><router-link to="/content/ALLVOD">Listar</router-link></li>
          </ul>
        </li>
        <li class="">	
          ...
          <ul aria-expanded="true">
            ...
            <li class=""><router-link to="/content/FeaturedLIVE">Destacar</router-link></li>
            <li class=""><router-link to="/content/PPV">Pay-Per-View</router-link></li>
